...
namespace MLnew.Data.Migrations
{
    ...
    [Migration("20240521092837_ConnectionHistory")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MLnew.Models.ConnectionHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MLnew.Models.Historique", b =>
                {
            ...
            modelBuilder.Entity("MLnew.Models.Methode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MLnew.Models.Modele", b =>
                {
            ...
            modelBuilder.Entity("MLnew.Models.Parametre", b =>
                {
                    b.Property<int>("ParametreID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ParametreID"), 1L, 1);
            ...
            modelBuilder.Entity("MLnew.Models.Simulation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MLnew.Models.Modele", b =>
                {
                    b.HasOne("MLnew.Models.Historique", "Historique")
                        .WithMany("Modeles")
            ...
            modelBuilder.Entity("MLnew.Models.Parametre", b =>
                {
                    b.HasOne("MLnew.Models.Modele", "Modele")
                        .WithMany("Parametres")
            ...
            modelBuilder.Entity("MLnew.Models.Simulation", b =>
                {
                    b.HasOne("MLnew.Models.Methode", "Methode")
